...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        list.sort(Comparator.comparing(Stock::getName).thenComparing(Stock.getDateSort()).thenComparingDouble(Stock::getProfit));
    }
    ...
    public static class Stock extends HashMap<String, Object> {
        ...
        private static Comparator<Stock> getDateSort() {
            return (d1, d2) -> ((Date)d2.get("date")).compareTo(((Date)d1.get("date")));
        }

        private double getProfit() {
            return this.containsKey("change") ? -(double) this.get("change") :
                    -((double) this.get("last") - (double) this.get("open"));
        }
    }
