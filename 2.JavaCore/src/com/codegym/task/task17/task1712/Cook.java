...
public class Cook implements Runnable {
    ...
    private void cook() throws InterruptedException {
        ...
        System.out.printf("The order will be prepared in %d ms for table %d%n", order.getTime(), order.getTableNumber());
        Thread.sleep(order.getTime());     // Prepare the dish
        Dish dish = new Dish(order.getTableNumber());       // This is a prepared dish
        System.out.printf("The order for table %d is ready%n", dish.getTableNumber());
