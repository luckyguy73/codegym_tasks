...
public class Solution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (BufferedReader fileReader = new BufferedReader(new FileReader(fileName))) {
            while (fileReader.ready()) products.add(getProduct(fileReader.readLine()));
        }
        ...
        switch (args[0]) {
            case "-u":{
                ...
                for (Product product : products) if (product.id == id) productToUpdate = product;
            ...
            case "-d": {
                ...
                for (Product product : products) if (product.id == id) productToDelete = product;
